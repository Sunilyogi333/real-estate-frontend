...
const Search = () => {
  return (
    <>
      <h1 className='pt-5 px-14 text-2xl font-semibold'>1,780 listings in Nepal</h1>
      <p className='py-2 px-14 text-sm  text-gray-500'>Rent your next home at one of our properties</p>
      <div className='flex justify-start py-2 px-14'>
        <input
          type='text'
