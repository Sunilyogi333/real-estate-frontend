...
import bedrooms from "../public/Images/Icons/bedrooms.png";
import bathrooms from "../public/Images/Icons/bathrooms.png";
import area from "../public/Images/Icons/area.png";
import repair from "../public/Images/Icons/repair.png";
import active from "../public/Images/Icons/active.png";
        ...
        <div className="hello lg:w-3/5 md:flex-wrap lg:pr-4">
          <div className="flex justify-around lg:w-full border rounded lg:px-10 py-2 h-max flex-wrap">
            ...
            <div>
              <p>Bathrooms</p>
              <div className="flex items-center gap-2 mt-2">
                <Image src={bathrooms} alt="bedrooms" />
                <span className="font-semibold">4</span>
              </div>
            </div>
            <div>
